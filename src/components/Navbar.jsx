            ...
            "fixed w-full z-40 transition-all duration-300",
             ...
             >
                ...
                <span className="relative  z-10">
                    {" "}
                    <span className="text-glow text-foreground"> Patrik Golian</span> Portfolio
                </span>
                ...
                <button onClick={() => setIsMenuOpen((prev) => !prev)} className="md:hidden p-2 text-foreground z-50" aria-label={isMenuOpen ? "Close menu" : "Open menu"}>{isMenuOpen ? <X size={24}/> : <Menu size={24} /> }</button>
                    ...
                    <div className={cn("fixed inset-0 bg-background/95 backdroup-blur-md z-40 flex  flex-col items-centered justify-center",
